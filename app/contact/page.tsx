...
export default function Contact() {
  return (
    <>
      <Header />
      <main className="shell grid gap-10 py-16 md:grid-cols-2">
        <div>
          ...
          <p className="mt-6 leading-7 text-stone-600">
            Hubungi kami untuk pesanan rutin, kebutuhan usaha, atau konsultasi
            hidroponik.
          </p>
          <div className="mt-8 space-y-4 text-sm">
            ...
            <p>
              ...
              <a
                className="hover:text-forest"
                href="mailto:kompenisayur@gmail.com"
              >
                kompenisayur@gmail.com
              </a>
            </p>
            <p>
              <b>Instagram</b>
