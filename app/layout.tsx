...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) { return <html lang="id"><body className={poppins.variable}><LanguageProvider>{children}</LanguageProvider></body></html>; }
